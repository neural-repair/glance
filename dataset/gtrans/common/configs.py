...
cmd_opt.add_argument('-save_dir_dot_file', default='.', help='result output for the dot files')
...
if cmd_args.save_dir_dot_file is not None:
    if not os.path.isdir(cmd_args.save_dir_dot_file):
        os.makedirs(cmd_args.save_dir_dot_file)
