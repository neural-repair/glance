...
def generate_dot_file(read_path, output_dir, item):
    ...
    (num_nodes, num_edges, ast_bug_dot) = shift_node_ast_to_dot(ast_bug)
    ...
    print('file:{}, num_nodes:{}, num_edges:{}'.format(output_file_name, num_nodes, num_edges))
...
def get_file_info(ml_ast_json, list_of_files):
    ...
    for f in listdir(ml_ast_json):
        if isfile(join(ml_ast_json, f)) and f.endswith('.js'):
            ...
            # print('prefix={}, looking_for={}'.format(prefix, f))
