...
def json_to_cfg(input_file, output_file):
    with open(input_file, 'r') as f:
        ...
        nodes = []
        cf_graph: Dot = pydot.Dot('cfg_graph', graph_type='digraph')
        ...
        cf_graph.write('while-conditional.dot', format='raw', prog='dot')
...
#json_to_cfg(input_file='./latest-cfg-jsons/while-conditional.json',
#            output_file='./latest-cfg-jsons/while-conditional.png')

#json_to_cfg(input_file='./latest-cfg-jsons/while-conditional1.json',
#            output_file='./latest-cfg-jsons/while-conditional1.png')

json_to_cfg(input_file='./latest-cfg-jsons/while-conditional2-no-control-flow.json',
            output_file='./latest-cfg-jsons/while-conditional2-no-control-flow.png')
