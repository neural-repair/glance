...
def get_args():
    ...
    parser.add_argument("--batch_size", type=int, default=1, help="the size of one mini-batch")
    ...
    parser.add_argument("--num-epoch", type=int, default=200, help="number of epochs")
