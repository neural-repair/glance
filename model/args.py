...
def get_args():
    ...
    parser.add_argument("--dataset_yaml", type=str, default="config/dynamic_gcn.yaml", help="")

    parser.add_argument("--word-emb-size", type=int, default=300, help="")
    parser.add_argument("--log-dir", type=str, default="slice4context-experiments/log/")
    ...
    parser.add_argument("--batch_size", type=int, default=16, help="the size of one mini-batch")
    ...
    parser.add_argument("--beam-size", type=int, default=20, help="the beam size of beam search")
